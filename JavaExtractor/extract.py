...
def extract_on_head_commit(args, range_file_path, feature_file_path):
    ...
    command = ['java', '-cp', args.jar, 'JavaExtractor.App',
               ...
               '--num_threads', str(args.num_threads), '--repo', str(args.repo), '--chunk_file', range_file_path]
...
if __name__ == '__main__':
    ...
    for commit in commits:
        ...
        extract_on_head_commit(args, range_file_path, feature_file_path)
        repo.git.checkout(repo.head.commit.parents[0].hexsha)
