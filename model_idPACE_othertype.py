    ...
    for global_step in range(1, EPOCHS + 1):
        ...
        for name in cluster_list:
            ...
            for line in ff:
                ...
                data = line.rstrip('\n')
                pair = data.split('\t')
                wfile = open("dataset/cluster/4/" + name + "/" + pair[0] + "_" + pair[1] + ".txt", 'w')
                ...
                while tangled_line:
                    ...
                    nodes11, children1, nodes22, children2, _ = getData_id_type(tangled_l, dictt, embeddings)
                    output = sess.run([res],
                                    feed_dict={
                                            nodes_node1: nodes11,
                                            children_node1: children1,
                ...
                while untangled_line:
                    ...
                    nodes11, children1, nodes22, children2, _ = getData_id_type(untangled_l, dictt, embeddings)
                    output = sess.run([res],
                                    feed_dict={
                                            nodes_node1: nodes11,
                                            children_node1: children1,
